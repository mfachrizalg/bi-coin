...
moneter dan sistem keuangan \cite{bi_whitepaper2022}. Mata uang digital bank
...
dan distribusi likuiditas berjenjang, purwarupa KYC-tier dan limit transaksi,
transfer ritel, serta pengawasan belum dievaluasi sebagai satu artefak Fabric
yang kinerjanya dapat diukur.
...
pada kebutuhan akan purwarupa CBDC
ritel yang (i) mengintegrasikan penerbitan berjenjang, kepatuhan, transfer ritel,
serta pengawasan dalam satu sistem, (ii) selaras dengan rancangan dua jenjang
Bank Indonesia, dan (iii) dievaluasi melalui pengujian Hyperledger Caliper yang
dapat diulang dengan konfigurasi dan artefak yang dicatat. Penelitian ini
merancang dan
...
\begin{enumerate}
	...
	\item Bagaimana menerapkan kontrol kepatuhan pada lapisan \textit{chaincode}
	      berupa kebijakan KYC-tier yang diinspirasi pendekatan berbasis risiko,
	      penurunan tingkatan dompet, limit transaksi,
...
\begin{enumerate}
	...
	\item Mengimplementasikan kontrol kepatuhan pada \textit{chaincode} berupa
	      kebijakan KYC-tier yang diinspirasi pendekatan berbasis risiko,
	      penurunan tingkatan dompet, limit transaksi masuk
...
\begin{enumerate}
	...
	\item Komposisi beban transaksi dan distribusi
	      ...
	      konfigurasi transfer mempertahankan 116 pelanggan, 16 pedagang, dan
	      52 slot transaksi pada seluruh konfigurasi
	      \textit{worker}. Ronde
	      pemanasan berlangsung 30 detik, sedangkan ronde terukur berlangsung
	      120 detik.
	...
	\item Proses KYC disimulasikan secara terprogram tanpa integrasi penyedia
	      identitas nyata. Tingkatan BASIC, STANDARD, dan MERCHANT beserta limitnya
	      merupakan parameter purwarupa yang diinspirasi pendekatan berbasis risiko,
	      bukan ketentuan BI/OJK/FATF atau bukti kepatuhan APU/PPT. Sistem tidak
	      mencakup pemeriksaan sanksi/PEP, \textit{beneficial ownership},
	      \textit{ongoing due diligence}, pelaporan transaksi mencurigakan, atau
	      integrasi PPATK.
	\item Sistem memisahkan data identitas mentah di PostgreSQL dari jangkar dan
	      status KYC pada buku besar, tetapi belum menyediakan privasi transaksi.
	      ...
	      metadata dompet, KYC, dan graf transaksi terlihat oleh peserta kanal yang
...
\begin{enumerate}
	\item Memberikan rujukan teoretis tentang perancangan CBDC ritel berbasis
	      ...
	      distribusi melalui PJP, transaksi antarpengguna, dan pengawasan oleh
	      bank sentral.
	\item Menjelaskan penerapan Hyperledger Fabric untuk memodelkan pemisahan
	      ...
	      menempatkan data identitas mentah pada buku besar.
	\item Menyediakan purwarupa yang dapat digunakan sebagai bahan eksperimen
	      teknis untuk menguji alur penerbitan, transfer, pembatasan dompet,
	      kontrol kepatuhan, dan pencatatan peristiwa pengawasan.
	...
	\item Mendukung diskusi teknis pengembangan Rupiah Digital ritel dengan menunjukkan
	      batas kemampuan purwarupa, termasuk kebutuhan integrasi identitas
	      nyata, perluasan topologi, dan pengujian keamanan lanjutan, tanpa
