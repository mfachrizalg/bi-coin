...
% BI Treasury → bank/PJP custodian (penerbitan dan distribusi)
\draw[ar] (bi.east) to[out=15,in=175]
  node[pl, above, sloped, pos=0.55]{Distribusi dari Treasury} (himbara.west);
\draw[ar] (bi.east) to[out=-15,in=-175]
  node[pl, below, sloped, pos=0.55]{Distribusi dari Treasury} (commercial.west);
...
\node[actor] (pjp) at (6.0, -4.5) {PJP\\(Kustodian)};
...
\node[font=\scriptsize, align=center, anchor=west, fill=white, inner sep=1pt]
  at (3.0,-3.7) {Distribusi langsung\\ke kustodian};
