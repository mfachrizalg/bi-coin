...
dan kontrol akses berbasis peran. Jenjang institusional tersebut menjelaskan
...
ditetapkan Rp50.000 agar penggunaan berulang tetap berada dalam saldo awal
purwarupa. Populasi menyediakan pengirim, penerima, dan pedagang untuk rencana
transaksi
...
func (s *SmartContract) Mint(ctx contractapi.TransactionContextInterface,
    ...
    // ... validasi MSP Bank Indonesia dan pasokan global ...
    if amount <= 0 {
...
Fungsi tersebut memeriksa otorisasi, status dompet, nilai positif, dan saldo
pengirim sebelum memperbarui kedua dompet secara atomik.
...
func (s *SmartContract) Transfer(ctx contractapi.TransactionContextInterface,
    ...
    // ... periksa MSP pemanggil, sender & receiver tidak beku,
    // serta kecukupan saldo ...
...
func (h *Handler) RegisterRoutes(r *mux.Router) {
    ...
    walletMutation.Use(middleware.RequireRole(middleware.RoleBankPjp))
